...
class OthersViewController: UIViewController, MFMessageComposeViewControllerDelegate, DeviceSelectorViewControllerDelegate {
    ...
    @IBAction func chargeTapped() {
        guard let url = URL(string: "https://echarge.bmi.ir") else { return }
...
/*
 ...
 http://ip-api.com/json/5.255.113.132
 OR
 http://ip-api.com/json/ default your ip address will be used
 
 limit: 45 request per min
