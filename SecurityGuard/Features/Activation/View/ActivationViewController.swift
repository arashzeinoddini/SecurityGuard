...
//  SecurityGuard
//
//  Created by Arash Zeinoddini on 8/28/23.
//
...
class ActivationViewController: UIViewController, MFMessageComposeViewControllerDelegate, DeviceSelectorViewControllerDelegate {
